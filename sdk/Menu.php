...
class Menu extends BaseWechat {
	...
	public function create($data) {
		return $this->wx->httpPost('https://api.weixin.qq.com/cgi-bin/menu/create', $data);
	}
	public function query() {
		$menus = $this->wx->httpGet('https://api.weixin.qq.com/cgi-bin/menu/get');
		if (isset($menus['errcode']) && $menus['errcode'] == 46003) {
			$menus = ['menu'=>['button'=>[]]];
		}
		return $menus;
	}
	public function clear() {
		return $this->wx->httpGet('https://api.weixin.qq.com/cgi-bin/menu/delete');
	}
}